...
import { normalizarRUT, limpiarTelefono } from './normalizador';
import { calcularPorcentaje } from './utils';
import type { Dispensacion, DispensacionRaw } from '@/types/dispensacion';
import type { Cita, CitaRaw } from '@/types/cita';
